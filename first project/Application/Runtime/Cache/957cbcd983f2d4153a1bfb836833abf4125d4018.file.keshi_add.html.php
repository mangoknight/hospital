<?php /* Smarty version Smarty-3.1.6, created on 2018-01-01 17:14:36
         compiled from "./Application/Admin/View\HospitalManager\keshi_add.html" */ ?>
<?php /*%%SmartyHeaderCode:149315a40498046f465-85887606%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '957cbcd983f2d4153a1bfb836833abf4125d4018' => 
    array (
      0 => './Application/Admin/View\\HospitalManager\\keshi_add.html',
      1 => 1514687591,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '149315a40498046f465-85887606',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5a4049806346c',
  'variables' => 
  array (
    'keshi' => 0,
    'v' => 0,
...
<?php if ($_valid && !is_callable('content_5a4049806346c')) {function content_5a4049806346c($_smarty_tpl) {?><!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
...
" method="POST" enctype="multipart/form-data">
						...
						<input style="width:200px;height: 30px;"  name="z_name" ></input>
						</td>
						</tr>
						<tr>
						<td style="padding-top:10px; padding-bottom:20px;padding-right: 40px;padding-left: 10px;">	
						...
						<input  style="width:200px;height: 30px;"  name="field" ></input>
						</td>
						</tr>
						<tr>
						<td style="float:right;padding-top:10px; padding-bottom:20px;padding-right: 40px;padding-left: 10px;">	
						<label style="padding-left: 30px;padding-right: 10px;" for="doc-ipt-text-1"><font size="4">性别</font></label>
						<select name="gender" style="width: 200px;padding: 0px;height: 32px;font-size:10px; font-family:微软雅黑;">
					 		<option value="1" style="font-size:12px; font-family:微软雅黑;" >男</option>
					 		<option value="2" style="font-size:12px; font-family:微软雅黑;" >女</option>
						...
						<input  style="width:200px;height: 30px;"  name="age" ></input>
						</td>
						</tr>
						<tr>
						<td style="float:right;padding-top:10px; padding-bottom:20px;padding-right: 40px;padding-left: 10px;">
...
" style="font-size:12px; font-family:微软雅黑;" ><?php echo $_smarty_tpl->tpl_vars['v']->value['k_name'];?>
						...
						<input class="am-btn am-btn-default" type="submit" value="添加"></input>
						</td>
						</tr>
						</table>
