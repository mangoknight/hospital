<?php /* Smarty version Smarty-3.1.6, created on 2018-01-01 16:41:51
         compiled from "./Application/Admin/View\HospitalManager\qingjia.html" */ ?>
<?php /*%%SmartyHeaderCode:92305a4845ab8239f4-77509849%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '12a4aa3bedb3f978f31485ce53e3efca083b5895' => 
    array (
      0 => './Application/Admin/View\\HospitalManager\\qingjia.html',
      1 => 1514696038,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '92305a4845ab8239f4-77509849',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5a4845aba7d38',
  'variables' => 
  array (
    'info' => 0,
    'v' => 0,
...
<?php if ($_valid && !is_callable('content_5a4845aba7d38')) {function content_5a4845aba7d38($_smarty_tpl) {?><!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
        ...
        <div class="am-u-sm-12">
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              <thead>
              <tr>
                <th class="table-id">序号</th><th class="table-title">专家姓名</th><th class="table-type">请假时间</th><th class="table-type">请假原因</th><th class="table-type">状态</th><th class="table-set">操作</th>
              </tr>
              </thead>
              <tbody>
...
/qingjia_enter/qid/<?php echo $_smarty_tpl->tpl_vars['v']->value['q_code'];?>
">
                      <span class="am-icon-pencil-square-o"></span>同意</a>
                      <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"
                      href="<?php echo @__CONTROLLER__;?>
/qingjia_delete/qid/<?php echo $_smarty_tpl->tpl_vars['v']->value['q_code'];?>
" onclick="if(confirm('确定要拒绝吗？')) return true; else return false;"><span class="am-icon-trash-o"></span>拒绝</a>
                    </div>
                  </div>
                </td>
              </tr>
